...
import 'package:khunt_parivar_mataji_madh/Network/services/utils_services/install_apk_service.dart';
...
import 'package:khunt_parivar_mataji_madh/Utils/in_app_update_dialog_widget.dart';
...
class SplashController extends GetxController {
  ...
  Future<void> nextScreenRoute() async {
    ...
    debugPrint("userId value ::: ${getData(AppConstance.userId)}");
    if (getData(AppConstance.userId) == null) {
